...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Sortmasters Contact Message</title>
...
<tbody><tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <h1 style="color:tomato; text-align:center;">Sortmasters Contact Form</h1>
					</p>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
									<tbody><tr>
											<td valign="top" class="bodyContent" mc:edit="body_content">
												<p>Hello there Sortmasters Admin,</p>
												<p>This is to notify you that you have received a contact message from <a href="https://www.sortmasters.co.ke">Sortmasters Ltd Website</a></p>
                          <br><br>
                          Message From:     <strong>{{$email}}</strong><br><br>
                          Name:             <strong>{{$name}}</strong><br><br>
                          Phone:            <strong>{{$phone}}</strong><br><br>
                          Message Subject:  <strong>{{$subj}}</strong><br><br>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
						<tbody><tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								...
								<h6 style="text-align:center;margin-top: 9px;">Sortmasters Ltd</h6>
