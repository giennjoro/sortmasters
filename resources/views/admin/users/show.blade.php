                        ...
                        <div class="list-unstyled userlist" style="padding: 5%">
                            ...
                            <div class="row">
                                <div class="col-xs-4" style="margin: 3%;">
                                    <a href='/administrator/users/{{$user->slug}}/edit' ><button class="btn btn-success fa fa-edit"> Edit</button></a>
                                </div>
                                <div class="col-xs-2">

                                </div>
                                <div class="col-xs-4" style="margin: 3%;">
                                {!! Form::open(['action' => ['UsersController@destroy',$user->slug], 'method' => 'POST', 'onsubmit' => 'return ConfirmDelete()']) !!}
