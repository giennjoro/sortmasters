                      ...
                      <div class="card-body">
                        @if(count($admins) > 0)
                            ...
                            <tbody>
                                ...
                                <td>{{ $admin->email }}</td>
                                <td>
                                    <a href='/administrator/users/{{$admin->id}}' ><button class="btn btn-success fa fa-eye"> View</button></a>
                                </td>
                                <td> 
                                    <!-- <form action="route('users.destroy', ['id' => $admin->id])" method="delete">
                                        
                                    </form> -->
                                    {!! Form::open(['action' => ['UsersController@destroy',$admin->id], 'method' => 'POST', 'onsubmit' => 'return ConfirmDelete()', 'id' => 'delete_user_form']) !!}
