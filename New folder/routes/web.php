...
Route::post('/client_application/save','ApplicationsController@store')->name('store_application')->middleware('applicant');
...
Route::group(['prefix' => 'administrator', 'middleware' => ['admin',]], function(){
    ...
    Route::get('/', 'UsersController@home')->name('admin.home');
...
Route::get('/administrator', 'UsersController@home')->name('admin.login');
//subscriber store
